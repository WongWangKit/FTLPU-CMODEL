...
public:
    ...
    void reset_execution_state()
    {
        ...
        executed_read_count_ = 0;
        executed_write_count_ = 0;
    }
    ...
    std::size_t executed_read_count() const noexcept
    {
        return executed_read_count_;
    }

    std::size_t executed_write_count() const noexcept
    {
        return executed_write_count_;
    }
...
private:
    ...
    std::size_t executed_read_count_{0};
    std::size_t executed_write_count_{0};
    std::size_t cycle_{0};
