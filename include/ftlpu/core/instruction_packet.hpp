...
inline EncodedInstructionPacket encode_packet(const SxmInstruction& instruction)
{
    ...
    SxmInstruction::check_byte_planes(instruction.byte_planes);
    ...
    words[0] =
        ...
        | (instruction.byte_planes == 1 ? UINT32_C(1) << 31 : 0);
    ...
    const EncodedInstructionPacket& packet)
{
    ...
    const auto byte_planes = (control & (UINT32_C(1) << 31)) != 0
    ...
    case SxmOpcode::Transpose:
        ...
        return SxmInstruction::Transpose(
            std::move(srcs), std::move(dsts), byte_planes);
    ...
    case SxmOpcode::Permute: {
        ...
        return SxmInstruction::Permute(
            ...
            SxmWeightLayout::VectorColumns, byte_planes);
    }
    }
