...
constexpr std::size_t kSramBlocksPerSlice = kTileRows;
constexpr std::size_t kSramBanksPerTile = 2;
constexpr std::size_t kSramWordBytes = 16;
constexpr std::size_t kSramBankDepthWords = 4096;
constexpr std::size_t kSramDepthWords = kSramBankDepthWords * kSramBanksPerTile;
constexpr std::size_t kSramBankBytesPerTile = kSramBankDepthWords * kSramWordBytes;
constexpr std::size_t kSramBytesPerTile = kSramBanksPerTile * kSramBankBytesPerTile;
constexpr std::size_t kSramBytesPerSlice = kSramBlocksPerSlice * kSramBytesPerTile;
constexpr std::size_t kPhysicalVectorBytes = kSramBlocksPerSlice * kSramWordBytes;
constexpr std::size_t kSramBlockBytes = kSramBytesPerSlice;
...
static_assert(kSramBlocksPerSlice == 20);
static_assert(kSramBanksPerTile == 2);
static_assert(kSramWordBytes == 16);
static_assert(kSramBankDepthWords == 4096);
...
static_assert(kSramBytesPerTile == 128 * 1024);
