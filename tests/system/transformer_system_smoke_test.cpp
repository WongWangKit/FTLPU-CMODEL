...
int main()
{
    ...
    const auto& west0 = system->mxm_unit(0).ports().input();
    const auto& west1 = system->mxm_unit(1).ports().input();
    const auto& east0 = system->mxm_unit(2).ports().input();
    const auto& east1 = system->mxm_unit(3).ports().input();
