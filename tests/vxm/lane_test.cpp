...
int main()
{
    ...
    for (int value = 1; value <= 3; ++value) {
        ...
        repeated_config.set_stream_inputs(Hemisphere::East, input);
    ...
    collision.set_stream_inputs(Hemisphere::East, collision_input);
    collision.tick();
    collision.set_stream_inputs(Hemisphere::East, collision_input);
    ...
    parallel.set_stream_inputs(Hemisphere::East, streams);
    parallel.tick();
    ...
    for (int value = 1; value <= 3; ++value) {
        auto input = VxmLane::StreamBytes{};
        put_int32(input, 0, value);
        accumulation.set_stream_inputs(Hemisphere::East, input);
        accumulation.tick();
    ...
    for (const auto value : {-5, -2, -7}) {
        auto input = VxmLane::StreamBytes{};
        put_int32(input, 0, value);
        local_max.set_stream_inputs(Hemisphere::East, input);
        local_max.tick();
    }
    local_max.tick();
