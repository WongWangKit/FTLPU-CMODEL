...
{
    // Match Mxm::compute_column_block exactly: tiles arrive south-to-north,
    // and each supercell visits its eight lanes in ascending order.  The
    // architectural BF16 boundary makes this FP32 addition order observable.
    auto sum = 0.0f;
