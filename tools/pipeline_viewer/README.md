...
```text
http://127.0.0.1:8765/tools/pipeline_viewer/?trace=/docs/smollm2_block8_dequant_ffn_schedule.csv
```
...
LOD draw count; hit testing and event inspection always use the full trace.
